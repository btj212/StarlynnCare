...
# Cron probe 2026-08-24T23:02 UTC: OR source max=2026-08-21 (unchanged vs Sunday GHA 32627736751);
#   MN insertDate max=2026-08-23 (unchanged vs cron 2026-08-23); MN resolved max=2026-08-13 unchanged;
#   0 insertDate 08/24 events; all other states no new source data (CA/TX/WA/UT/IL/PA/AZ/MO need DB
#   or manual). Post-check: production_page_spot_check.py 153/153 pass on production.
# Cron probe 2026-08-23T23:02 UTC: Sunday GHA 32627736751 (08:14 UTC) already ingested OR +28
#   max=2026-08-21; AZ +46 max=2026-08-18; CA +81 max=2026-08-10; PA +21; MN +7; UT +4;
#   WA/IL/MO/TX +0. OR source max=2026-08-21 unchanged; MN insertDate max=2026-08-23 (+1 posting
#   delay: H AND S RESIDENCE LLC provider 36081 resolved 7/22); all other states no new source data.
