...
#   or manual).
# Run 30742425936 (2026-08-02T09:46 UTC, Sunday weekly schedule): OR +37 max=2026-07-31
#   (was 2026-07-24); MN +24 max=2026-07-21 (was 2026-07-14); AZ +42 max=2026-07-31; WA +61;
#   UT +3 max=2026-07-06; PA +28 (max unchanged 2026-08-28); CA/IL/TX/MO +0.
# Cron probe 2026-08-03T23:00 UTC: OR source max=2026-07-31 (unchanged); MN insertDate max=2026-08-02
#   (unchanged vs Aug 2 probe); all other states no new source data.
# Cron probe 2026-08-04T23:01 UTC: OR source max=2026-07-31 (unchanged vs Sunday ingest run
#   30742425936); MN insertDate max=2026-08-04 (+1 non-ALRC survey PDF: Holistic Home Care LLC
#   provider 34265, resolved 2024-09-18 — expected skipped at bundle/ingest); MN resolved max
#   2026-07-21 (unchanged); all other states no new source data (CA/TX/WA/UT/IL/PA/AZ/MO need DB
#   or manual).
