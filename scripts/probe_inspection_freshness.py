...
# Last known DB max dates from GitHub Actions weekly-inspection-ingest run 27385922982
# (2026-06-12T00:16 UTC). Used when DATABASE_URL is unavailable in automation env.
