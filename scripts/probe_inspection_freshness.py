...
# Last known DB max dates from GitHub Actions weekly-inspection-ingest run 27314810278
# (2026-06-11T00:12 UTC). Used when DATABASE_URL is unavailable in automation env.
