...
export function GovernanceBar() {
  return (
    <section
      ...
      className="bg-ink text-paper text-[13px] tracking-[0.01em] py-2.5"
    >
      <div className="mx-auto max-w-[1280px] px-10 flex items-center justify-between gap-6">
        {/* Left badge */}
        <div className="flex items-center gap-2 font-[family-name:var(--font-mono)] text-[10.5px] uppercase tracking-[0.16em] text-gold-soft shrink-0">
          <span className="w-1.5 h-1.5 rounded-full bg-gold" aria-hidden />
          Editorial Independence
        </div>

        {/* Statement */}
        <p className="flex-1 opacity-95 text-[13.5px] text-center md:text-left">
          {GOVERNANCE_24_WORDS
