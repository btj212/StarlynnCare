...
export const paStateConfig: StateHubConfig = {
  ...
  editorialCards: [
    ...
    {
      kind: "PA data story · Immediate jeopardy",
      title: "A 48-bed rural PA home holds the state's highest immediate-jeopardy count",
      desc: "Penn Highlands Jefferson Manor in Brookville recorded 21 IJ findings — more than any other licensed memory care facility in Pennsylvania.",
      meta: "Live · Inspection data analysis",
      href: "/pennsylvania/insights/pa-rural-home-highest-immediate-jeopardy",
      live: true,
    },
    {
      kind: "PA data story · County comparison",
      title: "Philadelphia's affluent suburbs have some of PA's worst memory care records",
      desc: "Chester County averages 80 deficiencies per facility — second-highest in the state — and outpaces Pittsburgh's Allegheny County on IJ findings per facility.",
      meta: "Live · Inspection data analysis",
      href: "/pennsylvania/insights/philadelphia-suburbs-worst-records",
      live: true,
    },
    {
      kind: "PA data story · Facility size",
      title: "Bigger isn't safer: PA's largest facilities average nearly 4× more severe citations",
      desc: "PA memory care facilities with 100+ beds average 5.1 severe findings per facility — nearly four times the rate of homes with fewer than 20 beds.",
      meta: "Live · Inspection data analysis",
      href: "/pennsylvania/insights/bigger-not-safer",
      live: true,
    },
    {
