...
const PAGE_DESC =
  "Inspection records and peer rankings for licensed California memory care facilities — CDSS citations, county benchmarks, and family-ready profiles.";
    ...
    <>
      ...
      <SampleFacilityRotationProvider facilities={data.gradeCardFacilities}>
        ...
        <div className="hidden md:block">
          ...
          <SiteNav countStateCode="CA" badge="California" ctaHref="/california/facilities" ctaLabel="Browse California facilities" hideStateLink />
