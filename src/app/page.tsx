...
export default async function Home() {
  ...
  const EDITORIAL_CARDS = [
    ...
    {
      kind: "Cost Breakdown",
      title: "What memory care actually costs in California",
      desc: "Regional medians, how RCFE bills are structured (base rate vs. level-of-care), what Medicare and Medi-Cal cover, and the line-item fees families miss.",
      meta: "Live · 18 min read",
    ...
    },
    {
      ...
      desc: "Regulation, staffing, environment of care, and cost — a side-by-side look at two common options when dementia care needs increase.",
      meta: "Live · 12 min read",
    ...
    },
    {
      ...
      desc: "What to ask the executive director, the night-shift staff, and the resident families you meet in the hallway — before, during, and after the visit.",
      meta: "Live · On-site checklist",
      href: "/california/37-questions-to-ask-on-a-tour",
      live: true,
    },
    {
      kind: "Glossary",
      title: "California memory care, in plain language",
      desc: "RCFE, Type A, ALW, and other terms you will see in licensing data — defined for families and discharge planners.",
      meta: "Live · Reference",
