...
const PAGE_DESC =
  "Analysis of state inspection records — chain scorecards, repeat citation patterns, cost vs quality, and geographic equity across licensed memory care facilities.";
