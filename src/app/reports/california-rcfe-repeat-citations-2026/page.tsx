...
const META_TITLE =
  "1 in 8 California Senior Care Facilities Has Repeat Regulatory Citations | StarlynnCare";
const DESC =
  "Analysis of 484 California RCFEs from CDSS inspection records: 63 facilities (13%) were cited for the same regulatory violation in 3 or more separate inspections. Includes chain operator scorecard.";
