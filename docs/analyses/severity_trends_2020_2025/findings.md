...
- **Deficiency rate 2021**: 0.33 deficiencies/inspection
- **Deficiency rate 2024 (peak)**: 0.77 deficiencies/inspection
- **Deficiency rate 2025**: 0.58 deficiencies/inspection
- **Post-COVID trend direction (2021→2024)**: UP (+132% change) — records are worsening
- **2024: Explicit MC designation facilities**: 1.02 deficiencies/inspection
- **2024: General RCFE (no explicit MC label)**: 0.45 deficiencies/inspection
