...
- **Worst month by total citations**: Aug (692 citations)
- **Worst month by serious (sev≥3) citations**: Aug (296 serious citations)
- **Lightest month for citations**: Feb (449 citations)
- **Worst season (by serious citations)**: Fall
- **Day-of-week with highest deficiency rate**: Fri (1.13 defic/insp)
- **Weekend vs midweek deficiency rate**: Weekend avg 0.89 vs midweek avg 0.66
- **Friday effect**: Not observed
